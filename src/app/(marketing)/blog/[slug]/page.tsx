  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <article className="prose prose-invert prose-lg max-w-none">
        ...
        <div className="text-xl text-muted-foreground mb-12 leading-relaxed prose prose-invert prose-lg max-w-none"><ReactMarkdown remarkPlugins={[remarkGfm]}>{useCase.intro}</ReactMarkdown></div>
